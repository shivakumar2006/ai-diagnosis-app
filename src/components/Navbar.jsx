...
const Navbar = () => {
    return (
        <div className='w-full h-20 sticky bg-gray-200 border-b-gray-300 border-2 flex flex-row justify-between items-center gap-0 rounded-b-2xl'>
            ...
            <div className="w-60 h-18 mr-200 flex flex-row justify-center items-center">
                <h1 className='text-3xl font-medium text-blue-500 mr-15 flex flex-row items-center'>MediMa<GiHealthNormal className='text-sm text-red-500 mt-1'/>e</h1>
            </div>
            
            
            <div className='w-80 h-18 flex flex-row justify-evenly items-center'>
                <div className='text-2xl cursor-pointer'>
                    <FiSun className='text-gray-500 hover:text-black'/>
                </div>
                {/*profile icon*/}
